...
public:
	...
	//! Shared scan-state setup for this table scan. The pushed-down order and adapters are applied to the shared row
	//! group source built by the global scan state, so there is no per-scan-state reorderer here
